let md5,makeid,port,secure;_c29‍.w("./functions.js",[["md5",["md5"],function(v){md5=v}],["makeid",["makeid"],function(v){makeid=v}]]);_c29‍.w("./settings.js",[["port",["port"],function(v){port=v}],["secure",["secure"],function(v){secure=v}]]);
...
app.get("/video/:rand", function (req, res) {
    ...
    _c29‍.g.console.log(req.session.id)
    if(!video) {
    ...
    if(fs.existsSync('downloads/' + md5(video))) {
        ...
        .on("response", response => {
            _c29‍.g.console.log(response.headers["content-length"]);
        })
        .pipe(myFile)
        .on("finish", () => {
            resPartial(res);
